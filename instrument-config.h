...
//-------------|-------------|-------|---------------|----------------------|-------|
// 0: squishy saw            |       |               |              |       |       |
   {  7,  8,  9,   155,   225,    200,      1,    100,     80,   150,      0,     40,},
// 1: wurlitzer              |       |               |              |       |       |
   {  1,  7,  0,     1,   200,    130,    100,     90,      0,     0,    100,     60,},
// 2: music box              |       |               |              |       |       |
   {  6,  0,  0,   200,   220,      1,      1,     10,      0,     0,      0,     76,},
// 3: modem lead             |       |               |              |       |       |
   {  7, 14,  0,   120,   150,    190,    210,     10,      0,     0,    200,    110,},
// 4: gritty bass            |       |               |              |       |       |
   {  0,  0,  3,     1,   252,    190,    255,     10,      0,     0,    120,    190,},
// 5: funky rhodes           |       |               |              |       |       |
   {  3,  1,  0,    20,    20,     20,    255,     90,    240,   200,    120,     70,},
// 6: sine time              |       |               |              |       |       |
   {  0,  0,  0,     1,     1,    100,      0,      0,      0,     0,      0,     64,},
// 7: clicky bass            |       |               |              |       |       |
   { 10,  0,  0,     1,     1,    190,    255,     10,     20,    10,    120,    190,},
// 8: soft rhodes            |       |               |              |       |       |
...
//  #0  | #1  | #2  | #3  | #4  | #5  | #6  | #7  |
//------|-----|-----|-----|-----|-----|-----|-----//
     127,  127,  127,  127,  127,  127,  127,  102
//------------------------------------------------//
};